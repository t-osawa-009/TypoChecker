...
let pathOption = StringOption(named: "directoryPath",
                              flag: "directoryPath",
                              required: true,
                              helpString: "search directoryPath", defaultValue: "")
...
let reportOption = StringOption(named: "report",
                              flag: "report",
                              required: false,
                              helpString: "output report type", defaultValue: ReportType.json.rawValue)
...
let configuration = Configuration(rootDirectory: _rootDirectory,    yamlDirectory: _yamlDirectory, reportType: _reportType)
